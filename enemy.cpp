...
// マクロ定義
//*****************************************************************************
#define TEXTURE_WIDTH				(200/4)	// キャラサイズ
#define TEXTURE_HEIGHT				(200/4)	// 
...
static INTERPOLATION_DATA g_MoveTbl0[] = {
	//座標									回転率							拡大率							時間
	{ XMFLOAT3(800.0f,  50.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
	{ XMFLOAT3(600.0f, 300.0f, 0.0f),	XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
};


static INTERPOLATION_DATA g_MoveTbl1[] = {
	//座標									   回転率							拡大率							時間
	{ XMFLOAT3(100.0f,   50.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),	XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
	{ XMFLOAT3(800.0f,  400.0f, 0.0f),        XMFLOAT3(0.0f, 0.0f, 0.0f),	XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
};


static INTERPOLATION_DATA g_MoveTbl2[] = {
	//座標									        回転率							拡大率							時間
	{ XMFLOAT3(480.0f,  50.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
	{ XMFLOAT3(800.0f, 500.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
};

static INTERPOLATION_DATA g_MoveTbl3[] = {
	//座標									        回転率							拡大率							時間
	{ XMFLOAT3(800.0f, 500.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
	{ XMFLOAT3(300.0f, 300.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),	    XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
};

static INTERPOLATION_DATA g_MoveTbl4[] = {
	//座標									        回転率							拡大率							時間
	{ XMFLOAT3(700.0f,  50.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),		XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
	{ XMFLOAT3(500.0f, 500.0f, 0.0f),	      XMFLOAT3(0.0f, 0.0f, 0.0f),	    XMFLOAT3(1.0f, 1.0f, 1.0f),	60 },
};
...
void UpdateEnemy(void)
{
				...
				for (int j = 0; j < ENEMY_MAX; j++)
				{
					...
					if (player[j].use == TRUE)
					{
						...
						if (ans == TRUE)
						{
							...
							// エフェクト発生
							SetEffect(player[0].pos.x, player[0].pos.y, 30);
	...
	if (g_EnemyCnt <= 0)
	{
		SetFade(FADE_OUT, MODE_WIN_RESULT);
	}
